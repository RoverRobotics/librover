...
class RoverRobotics::RMProtocolObject
    : public RoverRobotics::BaseProtocolObject {
 public:
  RMProtocolObject(const char *device, std::string new_comm_type,
 ...
 private:
  ...
  std::unique_ptr<Control::RoscoManualController> rosco_control_;
