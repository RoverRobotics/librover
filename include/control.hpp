...
struct robot_hip_velocities {
  float left_hip_velocity;
  float right_hip_velocity;
};
...
/*
 * @brief Translate linear, angular, and hip commands into target wheelspeeds based on
 * robot geometery
 * @param target_velocities is the target linear, angular, and hip velocities
 * @param robot_geometry is a description of the robot geometry
 */
...
class Control::RoscoManualController {
 public:
  /* constructors */
   ...
   * full power with no load
   */
  RoscoManualController(robot_motion_mode_t operating_mode,
                            robot_geometry robot_geometry,
                            float max_motor_duty = 0.95,
                            float min_motor_duty = 0.03, float left_trim = 1.0,
                            float right_trim = 1.0,
