...
namespace RoverRobotics
{
  ...
  Zero2ProtocolObject::Zero2ProtocolObject(
      ...
      Control::robot_motion_mode_t robot_mode, Control::pid_gains pid, Control::angular_scaling_params angular_scale)
  {
  ...
  void Zero2ProtocolObject::unpack_comm_response(std::vector<unsigned char> robotmsg)
  {
    ...
    if (msgqueue.size() >= msg_size && msgqueue[0] == START_BYTE_ && msgqueue[msg_size] == STOP_BYTE_)
    {
      int payload_index = 3;
      int16_t v16;
      int32_t v32;
      ...
      v32 = static_cast<int32_t>((static_cast<uint32_t>(msgqueue[++payload_index]) << 24) +
      ...
      v32 = static_cast<uint32_t>((static_cast<uint32_t>(msgqueue[++payload_index]) << 24) +
                                  (static_cast<uint32_t>(msgqueue[++payload_index]) << 16) +
                                  (static_cast<uint32_t>(msgqueue[++payload_index]) << 8) +
                                  static_cast<uint32_t>(msgqueue[++payload_index]));
